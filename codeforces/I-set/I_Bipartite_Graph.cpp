 ...
 * Solution for: https://codeforces.com/edu/course/2/lesson/7/2/practice/contest/289391/problem/I
*/
...
struct DSU {
    ...
    bool same_parity(int a, int b) {
        find(a); // compress and calculate parity to represent first
        find(b);
        return parity[a]^parity[b] == 0;
    }
};
ll n, m;
void pre_compute() {
