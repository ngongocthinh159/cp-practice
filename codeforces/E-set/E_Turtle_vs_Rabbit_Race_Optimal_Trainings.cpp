 ...
 * Solution for: https://codeforces.com/contest/1933/problem/E
*/
...
ll n,q,l,u;
ll a[mxN];
bool check(ll l, ll r, ll u, vector<ll> &prf) {
    ll start = prf[r-1] - prf[l-1];
    ll sec_len = a[r];
    return sec_len*u*2 > (2*start + sec_len - 1)*sec_len;
}
void solve() {
    cin >> n;
    for (int i = 1; i <= n; i++) {
