 ...
 * Solution for: https://codeforces.com/contest/2204/problem/C
*/
...
ll solve3(ll a, ll b, ll c, ll m) {
    ll A = m / a;
    ll AB = m / lcm(a, b);
    ll AC = m / lcm(a, c);
    ll ABC = m / lcm(a, lcm(b, c));
    return (A - AB - AC + ABC) * 6 + (AB - ABC) * 3 + (AC - ABC) * 3 + ABC * 2;
}
void solve() {
    ll a, b, c, m; cin >> a >> b >> c >> m;
    cout << solve3(a, b, c, m) << ' ' << solve3(b, a, c, m) << ' ' << solve3(c, a, b, m) << nline;
}
