 ...
 * Solution for: https://codeforces.com/edu/course/2/lesson/9/3/practice/contest/307094/problem/F
*/
...
void solve() {
    ...
    vector<int> freq_letter(26, 0);
    for (auto c : letters) freq_letter[c - 'a']++;
    int l = 0;
    ll ans = 0;
    for (int r = 0; r < n; r++) {
        freq_window[s[r] - 'a']++;
        
        while (l <= r && freq_window[s[r] - 'a'] > freq_letter[s[r] - 'a']) {
            freq_window[s[l] - 'a']--;
            l++;
        }
