 ...
 * Solution for: https://codeforces.com/edu/course/2/lesson/5/2/practice/contest/279653/problem/E
*/
...
void apply(int idx, int s, int e, ll val) {
    segtree[idx].val = val; // apply update
...
Data query(int idx, int s, int e, int l, int r) {
    if (s > r || e < l) return make_data(LINF);
