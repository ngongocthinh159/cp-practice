 ...
 * Solution for: https://codeforces.com/edu/course/2/lesson/4/3/practice/contest/274545/problem/D
*/
...
struct SegmentTree {
    ...
    void _update(int idx, int s, int e, int pos, int val) {
        if (s == e) {
            segtree[idx] = val;
            return;
        }
    ...
    int _query(int idx, int s, int e, int l, int r) {
        if (s > r || e < l) return 0;
