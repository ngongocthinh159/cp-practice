...
void solve() {
    ...
    for (int i = 0; i < nums.size() - 1; i++) {
        for (int j = i + 1; j < nums.size(); j++) {
            mp[nums[i]*nums[j]] = {nums[i], nums[j]};
        }
    }
    int a[7];
    cout << "? 1 2" << endl;
    ...
    if (p12.first == p23.first) {
        a[2] = p12.first; a[1] = p12.second; a[3] = p23.second;
    } else if (p12.first == p23.second) {
        a[2] = p12.first; a[1] = p12.second; a[3] = p23.first;
    } else if (p12.second == p23.first) {
        a[2] = p12.second; a[1] = p12.first; a[3] = p23.second;
    } else if (p12.second == p23.second) {
        a[2] = p12.second; a[1] = p12.first; a[3] = p23.first;
    }
