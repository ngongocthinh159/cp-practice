 ...
 * Solution for: https://codeforces.com/problemset/problem/1775/C
*/
...
ll n, x;
ll bitwise_AND_range(ll l, ll r) {
    assert(l <= r);
...
void solve() {
    ...
    ll ans = bitwise_AND_range(n, r);
    if (ans == x) cout << r << nline;
    else cout << -1 << nline;
}
