...
void solve() {
    ...
    int pending_1 = 0, tot_1 = 0;
    ll sum_ending_2 = 0, ans = 0;
    for (int i = 0; i < n; i++) {
        if (a[i] == 1) {
            pending_1++;
            tot_1++;
        ...
        if (a[i] == 2) {
            sum_ending_2 = sum_ending_2 * 2 % MOD1;
            sum_ending_2 = (sum_ending_2 + 2 * pending_1 % MOD1) % MOD1;
            pending_1 = 0;
        }
        if (a[i] == 3) {
            ll cur = (sum_ending_2 - (tot_1 - pending_1)) % MOD1;
            if (cur < 0) cur += MOD1;
            ans = (ans + cur) % MOD1;
        }
    }
