 ...
 * Solution for: https://codeforces.com/edu/course/2/lesson/4/4/practice/contest/274684/problem/C
*/
...
Data merge(Data &l, Data &r) {
    ...
    res.inversion = l.inversion + r.inversion;
    ll sur_sum = 0;
    for (int i = 0; i < MAX; i++) res.freq[i] = l.freq[i] + r.freq[i], sur_sum += l.freq[i];
    sur_sum -= l.freq[1];
    for (int i = 1; i < MAX - 1; i++) {
        res.inversion += r.freq[i]*sur_sum;
        sur_sum -= l.freq[i + 1];
    }
    return res;
}
...
void solve() {
    ...
    build(1, 0, n - 1, arr);
    // cout << query(1, 0, n - 1, 0, 2).inversion << nline;
    int t, pos, val, l, r;
    for (int i = 0; i < q; i++) {
        cin >> t;
        if (t == 1) {
            cin >> l >> r;
            l--, r--;
            cout << query(1, 0, n - 1, l, r).inversion << nline;
        } else {
            cin >> pos >> val;
            pos--;
