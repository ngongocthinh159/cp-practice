 ...
 * Solution for: https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=989
*/
...
void solve() {
    ...
    for (int i = 0; i < q; i++) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            if (dsu.same_set(u, v)) {
                cout << edges[i].w << nline;
                found = true;
                break;
            }
        }
        if (!found) cout << "no path" << nline;
    }
}
