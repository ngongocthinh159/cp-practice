 ...
 * Solution for: https://acm.hdu.edu.cn/showproblem.php?pid=4135
*/
...
void pre_compute() {
    _2pow[0] = 1;
    for (int i = 1; i < 15; i++) _2pow[i] = _2pow[i - 1] << 1;
}
ll f(ll r) {
    ll ans = 0;
    for (int mask = 1; mask < _2pow[top]; mask++) {
