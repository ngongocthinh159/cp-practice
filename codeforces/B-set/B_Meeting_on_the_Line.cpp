 ...
 * Solution for: https://codeforces.com/problemset/problem/1730/B
*/
...
void solve() {
    ...
    double l = 0 - DELTA, r = 1e8 + DELTA;
    for (int i = 0; i < 60; i++) {
        double m = l + (r - l)/2;
        double ans1 = getAns(m);
        double ans2 = getAns(m + DELTA);
        if (ans2 < ans1) {
            l = m;
        } else {
            r = m;
